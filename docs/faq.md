...
For example, a build-time integration against a **curated tool catalog** is exactly as valid an ARD use as open-ended run-time discovery across the public web.
