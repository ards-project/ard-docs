...
- **Get involved & give feedback:** ARD is developed in the open. Browse the code and reference implementations on [GitHub](https://github.com/ards-project), and share feedback, questions, bug reports, or proposed changes through the [ARD-spec issue tracker](https://github.com/ards-project/ard-spec/issues).
